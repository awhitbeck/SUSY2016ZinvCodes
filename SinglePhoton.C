...
void SinglePhoton(){
  ...
  //reading Single photon Data
     ...
     tData->Add("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_GJet_CleanVars/tree_SinglePhoton_2016B.root");
   
    tData->Add("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_GJet_CleanVars/tree_SinglePhoton_2016C.root");
  
   tData->Add("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_GJet_CleanVars/tree_SinglePhoton_2016D.root");
  ...
  tData->Add("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_GJet_CleanVars/tree_SinglePhoton_2016G.root");
     ...
     TFile *f=new TFile("InputSkimData2016_V10.root","RECREATE");     
     ...
     if( Data.MHT > MHTcut && Data.HT > HTcut && Data.NJets>= NJetscut && Data.Photons->at(0).Pt() > PhotonPtcut && Data.BTags>= BJetscut && index >0 && Data.DeltaPhi1> 0.5 && Data.DeltaPhi2>0.5 && Data.DeltaPhi3>0.3 && Data.DeltaPhi4>0.3 ){//Filling Yield(N_Obsereved) in Data
            bool PassTrigger=false;
            bool PassFilters=false;

         // if(Data.CSCTightHaloFilter==1 && Data.HBHENoiseFilter==1 && Data.HBHEIsoNoiseFilter==1 && Data.eeBadScFilter==1 && Data.EcalDeadCellTriggerPrimitiveFilter==1 && Data.NVtx>0){PassFilters=true;}
