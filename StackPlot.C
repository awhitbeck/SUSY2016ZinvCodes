...
void DataMC::plotHist(TH1F *h1,TH1F *h2,TH1F *hnp,TCanvas *c,std::string Region,std::string h1R,std::string h2R,std::string variable){
    ...
    tpav_txt->AddText("H_{T} >300.");
    tpav_txt->AddText("#gamma p_{T} > 200 ");
    tpav_txt->AddText("N_{jets} #geq 3");
    tpav_txt->AddText("H_{T}^{miss}>300");
   ...
   TPaveText *pCMS = new TPaveText(0.132107,0.9308003,0.8327759,0.9923583,"brNDC");
    ...
    pCMS->AddText("CMS #it{Preliminary}                   24.5 fb^{-1}, #sqrt{s}= 13 TeV");    
